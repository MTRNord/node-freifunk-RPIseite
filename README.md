...
[![Greenkeeper badge](https://badges.greenkeeper.io/MTRNord/node-freifunk-RPIseite.svg)](https://greenkeeper.io/)
...
```
$ git clone git@github.com:MTRNord/node-freifunk-RPIseite.git
```
